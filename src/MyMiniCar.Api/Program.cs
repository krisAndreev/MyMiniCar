...
// Supabase signs user tokens with rotating asymmetric keys (ES256). Discover the
// public JWKS via the project's OpenID configuration; JwtBearer auto-refreshes it.
